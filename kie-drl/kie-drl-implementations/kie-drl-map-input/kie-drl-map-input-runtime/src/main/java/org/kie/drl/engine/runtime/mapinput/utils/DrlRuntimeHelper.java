...
public class DrlRuntimeHelper {
    ...
    public static Optional<EfestoOutputDrlMap> execute(BaseEfestoInput<EfestoMapInputDTO> toEvaluate, EfestoLocalRuntimeContext context) {
        ...
        try {
            ...
            return Optional.of(new EfestoOutputDrlMap(modelLocalUriId, toEvaluate.getInputData().asMap()));
        } catch (Exception e) {
