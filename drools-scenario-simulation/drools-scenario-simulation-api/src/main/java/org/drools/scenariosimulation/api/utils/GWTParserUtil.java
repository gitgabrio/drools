...
/**
 * Class used to provide parsing methods using GWT XML library
 */
public class GWTParserUtil {

    private GWTParserUtil() {
    }
     ...
     * @return
     */
    public static String cleanupNodes(String fullXml, String containerNodeName, String nodeToRemoveName) {
     ...
     * @return
     */
    public static Map<Node, List<Node>> getChildrenNodesMap(String fullXml, String containerNodeName, String childNodeName) {
        Document document = getDocument(fullXml);
