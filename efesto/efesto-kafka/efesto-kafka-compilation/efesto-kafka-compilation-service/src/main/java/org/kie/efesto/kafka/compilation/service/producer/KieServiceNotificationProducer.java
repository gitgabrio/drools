...
import org.kie.efesto.kafka.compilation.gateway.messages.EfestoKafkaCompilationServiceNotificationMessage;
...
import static org.kie.efesto.kafka.api.KafkaConstants.COMPILATIONSERVICE_NOTIFICATION_TOPIC;
...
public class KieServiceNotificationProducer {
    ...
    public static void runProducer(KafkaKieCompilationService toPublish) {
    ...
    public static void runProducer(final Producer<Long, JsonNode> producer, KafkaKieCompilationService toPublish) {
        ...
        try {
            ...
            final ProducerRecord<Long, JsonNode> record =
                    new ProducerRecord<>(COMPILATIONSERVICE_NOTIFICATION_TOPIC, COUNTER.incrementAndGet(), jsonNode);
    ...
    static JsonNode getJsonNode(KafkaKieCompilationService toPublish) {
        EfestoKafkaCompilationServiceNotificationMessage notificationMessage = new EfestoKafkaCompilationServiceNotificationMessage(toPublish.getModelType());
